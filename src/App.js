...
function App() {
  ...
  function handleInput(event)
  {
    ...
    function getData()
    {
       var weather = axios(`https://api.openweathermap.org/data/2.5/weather?q=${enteredvalue}&appid=0dafeff9e1bc31ab1c2c5286435e2050`)
  ...
  return (
      <div className="flex flex-row justify-center h-[100vh] items-center" >
          ...
          <div style={{backgroundImage: "linear-gradient(120deg, #a6c0fe 0%, #f68084 100%)"}} className="p-2 rounded-md shadow">
              ...
              <input on onChange={handleInput} type="text" className="rounded-md h-6 text-sm mt-2 p-1 outline-none" placeholder="City Name?" />
